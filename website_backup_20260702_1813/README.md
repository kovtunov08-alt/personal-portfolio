...
Personal portfolio surface for **personal-portfolio**: responsive Astro site with hero, about, projects, skills, and a contact form with optional file upload.

## Project Surface Status

**Active.** This is the only active surface for now. Production target is **Vercel** after MVP (`@astrojs/vercel` adapter; contact API at `/api/contact`).
